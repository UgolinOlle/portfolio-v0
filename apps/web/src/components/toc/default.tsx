...
function ThumbTrack({ computed, thumbBox }: { computed: ComputedSVG; thumbBox: boolean }) {
  ...
  return (
    ...
    >
      ...
      {thumbBox && (
        <div
          className="bg-fd-primary absolute left-0 size-1 rounded-full opacity-(--opacity,0) transition-[opacity,offset-distance] [offset-distance:var(--offset-distance,0)]"
          style={{
