import { ArrowRight, Blocks, LayoutGrid } from 'lucide-react';
...
export const metadata: Metadata = {
  title: 'UI',
  description: 'Composants et blocks construits avec shadcn/ui, utilisés dans ce portfolio.',
};
      ...
      <main className="mx-auto max-w-3xl px-4 pt-32 pb-20">
        <div className="mb-12 space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Une collection de composants et de blocks construits avec shadcn/ui, utilisés dans ce
            portfolio.
          </p>
        </div>
